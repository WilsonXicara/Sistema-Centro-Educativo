...
public class CursoJpaController implements Serializable {
    ...
    public CursoEntity buscarPorNombre(String nombreCurso) {
        EntityManager em = getEntityManager();
        TypedQuery<CursoEntity> query = em.createNamedQuery("Curso.buscarCursoPorNombre", CursoEntity.class);
    ...
    public void create(CursoEntity cursoEntity) {
        ...
        try {
            CursoEntity existente = buscarPorNombre(cursoEntity.getCurso());
            if (existente != null) {
    ...
    public void create(CursoEntity cursoEntity, EntityManager em) {
        em.persist(cursoEntity);
    }
    ...
    public void edit(CursoEntity cursoEntity, EntityManager em) {
        em.merge(cursoEntity);
    }
