...
public class DetallePensumEntity implements Serializable {
    ...
    private Integer creditos=0, prerrequisito_creditos=0;
    ...
    public String toString() {
        return "sce.principal.entity.DetallePensumEntity{" + "id=" + id + ", pensum_id=" + pensum_id + ", curso_id=" + curso_id + ", grado_id=" + grado_id + ", prerrequisito_curso_id=" + prerrequisito_curso_id + ", creditos=" + creditos + ", prerrequisito_creditos=" + prerrequisito_creditos + '}';
    }
